...
public class XMLBase
{
	...
	private HashMap<String, String> global_namespaces;
	// Prefix (String) to namespace (String) reverse mapping
	private HashMap<String, String> global_prefixes;
	...
	public XMLBase()
	{
		Class<? extends XMLBase> c = this.getClass();
		String n = c.getName();
		initDebug(n);
		initNamespaces();
	}
	...
	private void initNamespaces()
	{
		...
		this.global_namespaces = new HashMap<String, String>();
		this.global_prefixes = new HashMap<String, String>();
	...
	{
		String oldprefix = this.global_namespaces.get(namespace);
		if(oldprefix != null)
		{
		...
		if(prefix != null)
		{
			String oldnamespace = this.global_prefixes.get(prefix);
	...
	{
		String prefix = this.global_namespaces.get(namespace);
		if(prefix == null)
		{
			prefix = autoprefix();
			this.global_namespaces.put(namespace, prefix);
