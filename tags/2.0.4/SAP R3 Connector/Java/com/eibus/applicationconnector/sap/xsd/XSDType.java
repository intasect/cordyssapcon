...
public class XSDType
{
	...
	private ArrayList<QName> memberrefs;
	...
	private ArrayList<XSDAttribute> attributes;
	// member types, see 'memberrefs'
	private ArrayList<XSDType> members;
	...
	public XSDType()
	{
		...
		this.attributes = new ArrayList<XSDAttribute>();
		this.members = new ArrayList<XSDType>();
		this.restricted = false;
		this.mixed = false;
		this.memberrefs = new ArrayList<QName>();
	}
	 ...
	 */
	public ArrayList<XSDAttribute> getAttributes()
	{
	 ...
	 */
	public ArrayList<XSDType> getMemberTypes()
	{
		return this.members;
	}
	 ...
	 */
	public ArrayList<QName> getMemberRefs()
	{
