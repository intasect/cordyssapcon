...
public class XSDSchema extends XSDSequence
{
	...
	private String tns;
	// Top-level XSDTypes
	private ArrayList<XSDType> types;
	...
	private ArrayList<String> importnamespaces;
	...
	public XSDSchema()
	{
		...
		this.tns = null;
		this.types = new ArrayList<XSDType>();
		this.groups = new ArrayList<XSDSequence>();
		this.includes = new ArrayList<String>();
		this.imports = new ArrayList<String>();
		this.importnamespaces = new ArrayList<String>();
	 ...
	 */
	public ArrayList<XSDType> getTypes()
	{
		return this.types;
	}
	 ...
	 * @see getImports
	 */
	public ArrayList<String> getImportNamespaces()
	{
